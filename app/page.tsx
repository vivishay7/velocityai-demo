...
export default function Page(){
  ...
  // Grouped capacity sources (table)
  ...
  return (
    <div className="container">
      ...
      <p className="small">We connect your AI tools (Copilot, Asana AI, Workflows, RPA, AI Agents), capture the time they create, redeploy it to priority work, and prove dollars—Operational, Cost avoided, and Strategic. No forecasts. No timesheets.</p>
      ...
      <div className="row" id="kpis">
        ...
        <div className="card kpi"><h3 className="h">Cost avoided (harvested)</h3><div><b>${Math.round(costAvoided).toLocaleString()}</b></div><span className="small">RPA contractor cuts, AI‑answered tickets</span></div>
        <div className="card kpi"><h3 className="h">Strategic (growth/capability)</h3><div><b>${Math.round(strategic).toLocaleString()}</b></div><span className="small">More qualified deals + skill hours</span></div>
      </div>
      ...
      <div className="card">
        ...
        <table className="table">
          <thead><tr><th>AI tool → Outcome</th><th>Confidence</th><th>Minutes</th><th>~Hours</th></tr></thead>
          <tbody>
